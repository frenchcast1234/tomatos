...
class _DesksState extends State<Desks> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: windowStateNotifier,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            for (int i = 0; i < deskApps[deskIdx]["apps"].length; i++) ...[
                              Container(
                                height: double.infinity,
                                width: 300.0,
                                child: AbsorbPointer(child: deskApps[deskIdx]["apps"][i]),
                              ),
                              if (i < deskApps[deskIdx]["apps"].length - 1)
                                SizedBox(width: getSizeOf("spaceBetweenApps", "width")),
                            ]
                          ],
                        ),
                      ),
